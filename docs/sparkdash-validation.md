...
| Candidate bundle / restore gate | Candidate 2078c8a generated with pinned SDK, lockfile, relative generated flash arguments and checksums. All checksums and flash references verified. Full-image recovery passed; final release acceptance still awaits remaining interaction checks and an updated bundle. |
