...
| --- | --- |
| `sparklet-cover.png` | Original AI-generated editorial illustration made for Sparklet on 2026-09-05. It is conceptual artwork, not a hardware photograph or evidence of actual UI behavior. |
| `head-overview.jpeg` | User-supplied `IMG_2414.jpeg`, showing the head-node Overview on an earlier development build. |
| `worker-overview.jpeg` | User-supplied `IMG_2415.jpeg`, showing the worker-node Overview on that build. |
| `node-details.jpeg` | User-supplied `IMG_2417.jpeg`, showing the scrollable Details view on that build. |
